...
.. csv-table::
   ...
   "Daily solar radiation incident (average GHI for location)", "solar_radiation", ":math:`MJ/d/m^2`"
   ...
   "Evaporation rate calculation parameter A", "evap_rate_calc_a_parameter", ":math:`m^2*mm/MJ`"
   "Evaporation rate calculation parameter B", "evap_rate_calc_b_parameter", ":math:`1/K`"
   "Evaporation rate calculation parameter C", "evap_rate_calc_c_parameter", ":math:`dimensionless`"
...
.. csv-table::
   ...
   "Evaporation rate of pure water", "evap_rate_pure_constraint"
   "Adjusted evaporation rate for salinity", "evap_rate_salt_constraint"
   "Base area", "area_constraint"
   "Adjusted area", "area_adj_constraint"
