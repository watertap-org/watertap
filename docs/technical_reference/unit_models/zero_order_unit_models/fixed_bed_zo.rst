...
.. csv-table::
   ...
   "Consumption rate of acetic acid", "acetic_acid_demand", ":math:`kg/hr`"
   "Consumption rate of phosphoric acid", "phosphoric_acid_demand", ":math:`kg/hr`"
   "Consumption rate of ferric chloride", "ferric_chloride_demand", ":math:`kg/hr`"
   "Replacement rate for activated carbon", "activated_carbon_demand", ":math:`kg/hr`"
   ...
   "Replacement rate for sand", "sand_demand", ":math:`kg/hr`"
   ...
   "Replacement rate for anthracite", "anthracite_demand", ":math:`kg/hr`"
   ...
   "Replacement rate for cationic polymer", "cationic_polymer_demand", ":math:`kg/hr`"
