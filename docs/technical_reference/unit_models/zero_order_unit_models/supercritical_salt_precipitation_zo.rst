...
Costing Method
--------------
Costing is calculated using the :py:meth:`~watertap.unit_models.zero_order.supercritical_salt_precipitation_zo.SaltPrecipitationZOData.cost_supercritical_salt_precipitation` method.
