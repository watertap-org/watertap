...
.. csv-table::
   ...
   "Parameter A for electricity calculation", "electricity_a_parameter", ":math:`kW/ft^3`"
...
.. csv-table::
   ...
   "Filter press capacity constraint", "filter_press_capacity_constraint"
   "Filter press electricity constraint", "filter_press_electricity_constraint"
