...
.. csv-table::
   ...
   "Adsorbent exponential cost coefficients (U.S. EPA, 2021)", ":math:`y`", "adsorbent_unit_cost_coeff", "tabulated", ":math:`\text{dimensionless}`"
