...
.. csv-table::
   :header: "Unit Model", "Property Package", "GitHub Code"
   :widths: 35, 30, 35

   ":ref:`Aeration Tank <aeration_tank>`", ":ref:`ASM1 <ASM1>`<br>:ref:`ASM2d <ASM2d>`<br>:ref:`Modified ASM2d <modified_ASM2d>`", "`AerationTank <https://github.com/watertap-org/watertap/blob/main/watertap/unit_models/aeration_tank.py>`_"
   ":ref:`Anaerobic Digester <anaerobic_digester>`", ":ref:`ADM1 <ADM1>`<br>:ref:`Modified ADM1 <modified_ADM1>`", "`AD <https://github.com/watertap-org/watertap/blob/main/watertap/unit_models/anaerobic_digester.py>`_"
   ...
   ":ref:`CSTR Injection <CSTR_injection>`", ":ref:`ASM1 <ASM1>`<br>:ref:`ASM2d <ASM2d>`<br>:ref:`Modified ASM2d <modified_ASM2d>`", "`CSTR_Injection <https://github.com/watertap-org/watertap/unit_models/cstr_injection.py>`_"
   ":ref:`Dewatering Unit <dewatering>`", ":ref:`ASM1 <ASM1>`<br>:ref:`ASM2d <ASM2d>`<br>:ref:`Modified ASM2d <modified_ASM2d>`", "`DewateringUnit <https://github.com/watertap-org/watertap/unit_models/dewatering.py>`_"
   ...
   ":ref:`0D Steam Heater <steam_heater_0D>`", ":ref:`Water <water>`<br>:ref:`Seawater <seawater>`", "`SteamHeater0D <https://github.com/watertap-org/watertap/blob/main/watertap/unit_models/steam_heater_0D.py>`_"
   ...
   ":ref:`Thickener <thickener>`", ":ref:`ASM1 <ASM1>`<br>:ref:`ASM2d <ASM2d>`<br>:ref:`Modified ASM2d <modified_ASM2d>`", "`Thickener <https://github.com/watertap-org/watertap/blob/main/watertap/unit_models/thickener.py>`_"
   ":doc:`Translators <translators/index>`", "-", "-"
   ":ref:`UV AOP <UV_AOP>`", ":ref:`MCAS <mcas_tech_ref>`<br>NDMA (TBD)", "`Ultraviolet0D <https://github.com/watertap-org/watertap/blob/main/watertap/unit_models/uv_aop.py>`_"
   ":doc:`Zero-Order Unit Models <zero_order_unit_models/index>`", "-", "-"
   ":doc:`Unit Model Utility Functions <unit_model_utilities>`", "-", "-"