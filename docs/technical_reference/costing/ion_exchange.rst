...
.. csv-table::
   ...
   "Unit cost of NaCl", "``NaCl_cost``", "0.09", ":math:`\text{USD}_{2020}\text{/kg}`", "Assumes solid NaCl. From CatCost v 1.0.4"
   "Unit cost of HCl", "``HCl_cost``", "0.17", ":math:`\text{USD}_{2020}\text{/kg}`", "Assumes 37% solution HCl. From CatCost v 1.0.4"
   "Unit cost of NaOH", "``NaOH_cost``", "0.59", ":math:`\text{USD}_{2020}\text{/kg}`", "Assumes 30% solution NaOH. From iDST"
   "Unit cost of Methanol (MeOH)", "``MeOH_cost``", "3.395", ":math:`\text{USD}_{2008}\text{/kg}`", "Assumes 100% pure MeOH. From ICIS"
