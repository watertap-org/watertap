...
.. csv-table::
   ...
   "Fraction of inert COD generated in lysis, f_XI", ":math:`f_{XI}`", "f_XI", 0.1, ":math:`\text{dimensionless}`"
...
.. csv-table::
   ...
   "Saturation coefficient for oxygen", ":math:`KH_{O2}`", "KH_O2", 0.0002, ":math:`\text{kg O_2/}\text{m}^{3}`"
   "Saturation coefficient for nitrate", ":math:`KH_{NO3}`", "KH_NO3", 0.0005, ":math:`\text{kg N/}\text{m}^{3}`"
