...
.. csv-table::
   ...
   ":blue:`P content of fermentable substrate, S_F`", ":math:`i_{SF}`", "i_SF", 0.00559, ":math:`\text{dimensionless}`"
...
.. csv-table::
   ...
   "Saturation coefficient for phosphate (nutrient)", ":math:`KH_PO4`", "KH_PO4", 0.00001, ":math:`\text{kg P/}\text{m}^{3}`"
   ...
   ":blue:`Decay rate of X_AUT`", ":math:`b_{AUT}`", "b_{AUT}", 0.09, ":math:`\text{day}^{-1}`"
