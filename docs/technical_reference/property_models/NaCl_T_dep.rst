...
.. csv-table::
   ...
   "Dynamic viscosity", ":math:`\mu`", "visc_d_phase", "[p]", ":math:`\text{Pa}\text{s}`"
   "Thermal Conductivity", ":math:`k`", "th_cond_phase", "[p]", ":math:`\text{W}\text{m*K}`"
   "Specific Heat Capacity", ":math:`C_p`", "cp_mass_phase", "[p]", ":math:`\text{J/kg*K}`"
   "Solute diffusivity", ":math:`D`", "diffus", [p,'NaCl'], ":math:`\text{m}^2\text{/s}`"
