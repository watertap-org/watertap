...
.. csv-table::
   ...
   "Fraction of inert COD from lysis, f_XI", ":math:`f_{XI}`", "f_XI", 0.1, ":math:`\text{dimensionless}`"
   "Fraction of inert COD from lysis, f_XIH", ":math:`f_{XIH}`", "f_XIH", 0.1, ":math:`\text{dimensionless}`"
   "Fraction of inert COD from lysis, f_XIP", ":math:`f_{XIP}`", "f_XIP", 0.1, ":math:`\text{dimensionless}`"
   "Fraction of inert COD from lysis, f_XIA", ":math:`f_{XIA}`", "f_XIA", 0.1, ":math:`\text{dimensionless}`"
