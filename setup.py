...
setup(
    ...
    entry_points={
        "watertap.flowsheets": [
            "nf = watertap.flowsheets.flowsheets.nf_dspmde.nf_ui",
            "nf_with_bypass = watertap.flowsheets.flowsheets.nf_dspmde.nf_with_bypass_ui",
            "bsm2 = watertap.flowsheets.flowsheets.zero_order.full_water_resource_recovery_facility.BSM2_ui",
            "bsm2_P_extension = watertap.flowsheets.flowsheets.zero_order.full_water_resource_recovery_facility.BSM2_P_extension_ui",
            "dye_desalination = watertap.flowsheets.flowsheets.zero_order.wastewater_resource_recovery.dye_desalination.dye_desalination_ui",
            "mvc = watertap.flowsheets.flowsheets.mvc.mvc_single_stage_ui",
            "RO = watertap.flowsheets.flowsheets.RO_with_energy_recovery.RO_with_energy_recovery_ui",
            "OARO = watertap.flowsheets.flowsheets.oaro.oaro_multi_ui",
            "GAC = watertap.flowsheets.flowsheets.gac.gac_ui",
        ],
    },
)
