...
def test_heat_exchanger():
    ...
    assert pytest.approx(90384.223, rel=1e-4) == value(m.fs.unit.heat_duty[0])
    ...
    assert pytest.approx(328.611, rel=1e-4) == value(
    ...
    assert pytest.approx(340.402, rel=1e-4) == value(
