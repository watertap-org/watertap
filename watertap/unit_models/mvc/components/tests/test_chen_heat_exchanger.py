...
def test_heat_exchanger():
    ...
    assert pytest.approx(268194.66, rel=1e-4) == value(m.fs.unit.heat_duty[0])
    ...
    assert pytest.approx(351.287, rel=1e-4) == value(
    ...
    assert pytest.approx(296.008, rel=1e-4) == value(
