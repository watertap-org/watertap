...
def test_mvc():
    ...
    assert m.fs.evaporator.lmtd.value == pytest.approx(30.39, rel=1e-3)
    assert m.fs.evaporator.heat_transfer.value == pytest.approx(1.216e7, rel=1e-3)
    ...
    assert compressed_blk.pressure.value == pytest.approx(3.9771e4, rel=1e-3)
