...
def display_design(m):
    ...
    print(
        ...
        % (
            value(
                m.fs.unit.flux_mass_phase_comp[
                    0, m.fs.unit.length_domain.at(2), "Liq", "H2O"
                ]
            )
            / 1e3
            * 1000
    ...
    print(
        ...
        % (
            value(
                m.fs.unit.flux_mass_phase_comp[
                    0, m.fs.unit.length_domain.last(), "Liq", "H2O"
                ]
            )
            / 1e3
            * 1000
    ...
    print(
        ...
        % (-m.fs.unit.feed_side.deltaP_stage[0].value / 1e5)
    )
    print(
    ...
    print(
        ...
        % (-m.fs.unit.permeate_side.deltaP_stage[0].value / 1e5)
    )
...
def plot(m):
    ...
    salt_flux_in = value(
        pyunits.convert(
            m.fs.unit.flux_mass_phase_comp[
                0, m.fs.unit.length_domain.at(2), "Liq", "NaCl"
            ],
