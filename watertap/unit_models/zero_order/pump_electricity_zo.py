...
@declare_process_block_class("PumpVariableEfficiencyZO")
class PumpVariableEfficiencyZOData(PumpElectricityZOData):
    """
    ...
    def build(self):
        ...
        def flow_ratio_constraint(b, t):
            return b.flow_ratio[t] == b.properties[t].flow_vol / pyunits.convert(
                b.properties.flow_bep, to_units=pyunits.m**3 / pyunits.s
            )
        ...
        def eta_ratio_constraint(b, t):
            if b.config.process_subtype is "low pressure":
                ...
                raise ValueError(
                    "Correlation type ", self.config.correlation, " not recognized"
                )
