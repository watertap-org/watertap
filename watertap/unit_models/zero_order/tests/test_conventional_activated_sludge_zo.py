...
class Test_CASZOsubtype:
    ...
    def test_load_parameters(self, model, subtype):
        ...
        data = db.get_unit_operation_parameters("conventional_activated_sludge", subtype=subtype)
...
def test_costing():
    ...
    assert isinstance(m.fs.costing.conventional_activated_sludge.capital_a_parameter,
                      Var)
    assert isinstance(m.fs.costing.conventional_activated_sludge.capital_b_parameter,
                      Var)
