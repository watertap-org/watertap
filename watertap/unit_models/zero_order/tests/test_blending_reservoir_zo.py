...
class TestBlendingReservoirZO:
    ...
    def model(self):
        ...
        m.fs.unit = BlendingReservoirZO(default={
...
def test_costing():
    ...
    m.fs.unit1 = BlendingReservoirZO(default={
        "property_package": m.fs.params,
        "database": m.db})
    ...
    assert isinstance(m.fs.costing.blending_reservoir.capital_a_parameter,
                      Var)
    assert isinstance(m.fs.costing.blending_reservoir.capital_b_parameter,
                      Var)
