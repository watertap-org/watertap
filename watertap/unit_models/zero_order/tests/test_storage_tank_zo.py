...
def test_costing(subtype):
    ...
    m.fs.unit1 = StorageTankZO(default={
    ...
    assert isinstance(m.fs.costing.storage_tank.capital_a_parameter,
                      Var)
    assert isinstance(m.fs.costing.storage_tank.capital_b_parameter,
                      Var)
