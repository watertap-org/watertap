...
class TestStruviteClassifierZO:
    ...
    def model(self):
        ...
        m.fs.params = ZOParameterBlock(solute_list=["struvite"])
    ...
    def test_build(self, model):
        ...
        assert model.fs.unit._tech_type == "struvite_classifier"
    ...
    def test_load_parameters(self, model):
        data = model.db.get_unit_operation_parameters("struvite_classifier")
