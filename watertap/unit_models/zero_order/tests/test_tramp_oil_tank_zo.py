...
class TestTrampOilZOdefault:
    ...
    def model(self):
        ...
        m.fs.params = WaterParameterBlock(default={"solute_list": ["oil_and_grease"]})

        m.fs.unit = TrampOilTankZO(
    ...
    def test_build(self, model):
        ...
        assert model.fs.unit._tech_type == "tramp_oil_tank"
    ...
    def test_load_parameters(self, model):
        data = model.db.get_unit_operation_parameters("tramp_oil_tank")
...
def test_costing():
    ...
    assert isinstance(m.fs.costing.tramp_oil_tank.capital_a_parameter, Var)
    assert isinstance(m.fs.costing.tramp_oil_tank.capital_b_parameter, Var)
