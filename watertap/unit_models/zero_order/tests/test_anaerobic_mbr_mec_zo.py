...
class TestAnaerobicMBRMECZO:
    ...
    def test_solution(self, model):
        ...
        assert (pytest.approx(1500/3600/24/1000, rel=1e-5) ==
...
------------------------------------------------------------------------------------
    ...
    Reaction Extent [cod_to_nonbiodegradable_cod] : 5.0312e-05 : False : (None, None)
        ...
        Solute Removal [phosphate_as_phosphorous] :     0.0000 :  True : (0, None)
                                   Water Recovery :    0.39700 :  True : (1e-08, 1.0000001)

------------------------------------------------------------------------------------
    Stream Table
                                                   Inlet     Treated   Byproduct
    Volumetric Flowrate                         4.3750e-05 1.7333e-05 2.6417e-05
    Mass Concentration H2O                          997.55     999.61     996.19
    Mass Concentration cod                          2.3000 4.6155e-05     1.9046
    Mass Concentration nonbiodegradable_cod     2.2857e-16 4.6155e-05     1.9046
    Mass Concentration ammonium_as_nitrogen        0.10500    0.26508 3.0283e-05
    Mass Concentration phosphate_as_phosphorous   0.050000    0.12625 3.0283e-05
====================================================================================
"""
