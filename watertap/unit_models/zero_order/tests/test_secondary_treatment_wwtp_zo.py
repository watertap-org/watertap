...
class Test_SecondaryTreatmentWWTPZOsubtype:
    ...
    def test_load_parameters(self, model, subtype):
        ...
        data = db.get_unit_operation_parameters("secondary_treatment_wwtp", subtype=subtype)
...
def test_costing():
    ...
    assert isinstance(m.fs.costing.secondary_treatment_wwtp.capital_a_parameter,
                      Var)
    assert isinstance(m.fs.costing.secondary_treatment_wwtp.capital_b_parameter,
                      Var)
