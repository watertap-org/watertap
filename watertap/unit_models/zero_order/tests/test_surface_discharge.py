...
class TestSurfaceDischargeZO:
    ...
    def test_build(self, model):
        ...
        assert model.fs.unit._tech_type == "surface_discharge"
    ...
    def test_load_parameters(self, model):
        data = model.db.get_unit_operation_parameters("surface_discharge")
...
class TestSurfaceDischargeZOsubtype:
    ...
    @pytest.mark.component
    def test_load_parameters(self, model):
        data = model.db.get_unit_operation_parameters("surface_discharge", subtype="emwd")
