...
class TestCO2AdditionZO:
    ...
    def test_solution(self, model):
        ...
        assert pytest.approx(0.03412999, rel=1e-5) == value(
...
def test_costing():
    ...
    m.fs.unit1 = CO2AdditionZO(property_package=m.fs.params, database=m.db)
    ...
    assert isinstance(m.fs.costing.co2_addition.capital_a_parameter, Var)
    assert isinstance(m.fs.costing.co2_addition.capital_b_parameter, Var)
