...
from watertap.unit_models.zero_order import CO2AdditionZO
...
class TestCO2AdditionZO:
    ...
    def model(self):
        ...
        m.fs.unit = CO2AdditionZO(default={"property_package": m.fs.params,
                                           "database": m.db})
    ...
    def test_build(self, model):
        ...
        assert model.fs.unit._tech_type == "co2_addition"
    ...
    def test_solution(self, model):
        ...
        assert (pytest.approx(0.03412999, rel=1e-5) ==
...
def test_costing():
    ...
    m.fs.unit1 = CO2AdditionZO(default={
    ...
    assert isinstance(m.fs.costing.co2_addition, Block)
    assert isinstance(m.fs.costing.co2_addition.capital_a_parameter,
                      Var)
    assert isinstance(m.fs.costing.co2_addition.capital_b_parameter,
                      Var)
    assert isinstance(m.fs.costing.co2_addition.reference_state, Var)
