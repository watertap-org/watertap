...
###############################################################################
"""
This module contains a zero-order representation of a landfill zld unit operation.
"""
...
@declare_process_block_class("LandfillZLDZO")
class LandfillZLDZOData(ZeroOrderBaseData):
    """
    Zero-Order model for a landfill zld unit operation.
    """
