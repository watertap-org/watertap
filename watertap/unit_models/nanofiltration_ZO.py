    ...
    **Valid values:** {
    ...
    def build(self):
        ...
        def eq_mass_transfer_term(b, t, p, j):
            ...
            if b.feed_side.properties_in[0].get_material_flow_basis() == MaterialFlowBasis.mass:
                return (
                    b.mass_transfer_phase_comp[t, p, j] == -b.feed_side.mass_transfer_term[t, p, j]
                )
        ...
        def eq_recovery_vol_phase(b, t):
            return (
                ...
                == b.properties_permeate[t].flow_vol / b.feed_side.properties_in[t].flow_vol
            )
        ...
        def eq_permeate_isothermal(b, t):
            return b.feed_side.properties_in[t].temperature == b.properties_permeate[t].temperature
    ...
    def _get_performance_contents(self, time_point=0):
        ...
        for j in solute_set:
            ...
            obj_dict[f"{j} Molar Concentration @Outlet"] = self.feed_side.properties_out[
                time_point
            ].conc_mol_phase_comp["Liq", j]
