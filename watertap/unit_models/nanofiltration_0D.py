    ...
    **Valid values:** {
    ...
    def build(self):
        ...
        self.properties_permeate = self.config.property_package.state_block_class(
            self.flowsheet().config.time, doc="Material properties of permeate", default=tmp_dict
        )
        ...
        def eq_flux_in(b, t, p, j):
            ...
            if comp.is_solvent():
                ...
                return b.flux_mass_phase_comp_in[t, p, j] == b.B_comp[t, j] * (
                    ...
                    (1 - b.sigma[t])
                    * b.flux_mass_phase_comp_in[t, p, j]
                    * 1
                    / b.dens_solvent
                    * b.avg_conc_mass_phase_comp_in[t, p, j]
                )
        ...
        def eq_flux_out(b, t, p, j):
            ...
            if comp.is_solvent():
                ...
                return b.flux_mass_phase_comp_out[t, p, j] == b.B_comp[t, j] * (
                    ...
                    (1 - b.sigma[t])
                    * b.flux_mass_phase_comp_out[t, p, j]
                    * 1
                    / b.dens_solvent
                    * b.avg_conc_mass_phase_comp_out[t, p, j]
                )
        ...
        def eq_avg_conc_in(b, t, p, j):
            ...
            return b.avg_conc_mass_phase_comp_in[t, p, j] == (
                prop_feed.conc_mass_phase_comp[p, j]
        ...
        def eq_connect_enthalpy_transfer(b, t):
            return (
                b.properties_permeate[t].get_enthalpy_flow_terms("Liq")
        ...
        def eq_permeate_isothermal(b, t):
            return b.feed_side.properties_out[t].temperature == b.properties_permeate[t].temperature
