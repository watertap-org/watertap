...
#
#         bped_m[1].fs.unit.current_applied.fix(2e2)
#         bped_m[1].fs.unit.inlet_basate.flow_mol_phase_comp[0, "Liq", "Cl_-"].fix(7.38e-3)
#         bped_m[1].fs.unit.inlet_basate.flow_mol_phase_comp[0, "Liq", "H_+"].fix(7.38e-3)
#         bped_m[1].fs.unit.inlet_acidate.flow_mol_phase_comp[0, "Liq", "Na_+"].fix(7.38e-3)
#         bped_m[1].fs.unit.inlet_acidate.flow_mol_phase_comp[0, "Liq", "OH_-"].fix(7.38e-3)
#         bped_m[1].fs.unit.inlet_diluate.flow_mol_phase_comp[0, "Liq", "H_+"].fix(7.38e-3)
#         bped_m[1].fs.unit.inlet_diluate.flow_mol_phase_comp[0, "Liq", "OH_-"].fix(7.38e-3)
