...
import pytest
from pyomo.environ import ConcreteModel, Constraint, TerminationCondition, SolverStatus, value, Var
...
class TestNanoFiltration:
    ...
    def test_conservation(self, NF_frame):
        ...
        assert abs(value(flow_mass_inlet - flow_mass_retentate - flow_mass_permeate)) <= 1e-6
