...
def main():
    ...
    m.fs.feed.properties.calculate_state(
        var_args={
            ...
            ("conc_mass_phase_comp", ("Liq", "DCE")): 2.32,  # 2.32e-5,
        },
    ...
    mass_removal = (
        0.50 * m.fs.feed.properties[0].flow_mol_phase_comp["Liq", "DCE"].value
    )
    m.fs.gac.mass_solute_absorb[0, "Liq", "DCE"].fix(mass_removal)
    ...
    print("specified mass removal", mass_removal)
