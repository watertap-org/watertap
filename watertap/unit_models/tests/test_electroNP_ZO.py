...
class TestElectroNP:
    ...
    def ElectroNP_frame(self):
        ...
        m.fs.unit.inlet.conc_mass_comp[0, "S_O2"].fix(9.9999e-07)
        m.fs.unit.inlet.conc_mass_comp[0, "S_N2"].fix(9.9999e-07)
        m.fs.unit.inlet.conc_mass_comp[0, "S_NH4"].fix(1.6310)
        m.fs.unit.inlet.conc_mass_comp[0, "S_NO3"].fix(9.9999e-07)
        m.fs.unit.inlet.conc_mass_comp[0, "S_PO4"].fix(29.115)
        m.fs.unit.inlet.conc_mass_comp[0, "S_F"].fix(19.495)
        m.fs.unit.inlet.conc_mass_comp[0, "S_A"].fix(0.11094)
        m.fs.unit.inlet.conc_mass_comp[0, "S_I"].fix(0.026604)
        m.fs.unit.inlet.conc_mass_comp[0, "X_I"].fix(13.070)
        m.fs.unit.inlet.conc_mass_comp[0, "X_S"].fix(0.13979)
        m.fs.unit.inlet.conc_mass_comp[0, "X_H"].fix(9.9999e-07)
        m.fs.unit.inlet.conc_mass_comp[0, "X_PAO"].fix(9.9999e-07)
        m.fs.unit.inlet.conc_mass_comp[0, "X_PP"].fix(0.11430)
        m.fs.unit.inlet.conc_mass_comp[0, "X_PHA"].fix(7.2793)
        m.fs.unit.inlet.conc_mass_comp[0, "X_AUT"].fix(9.9999e-07)
        m.fs.unit.inlet.conc_mass_comp[0, "X_MeOH"].fix(9.9999e-07)
        m.fs.unit.inlet.conc_mass_comp[0, "X_MeP"].fix(9.9999e-07)
        m.fs.unit.inlet.conc_mass_comp[0, "X_TSS"].fix(9.9999e-07)
        m.fs.unit.inlet.conc_mass_comp[0, "S_K"].fix(0.33162)
        m.fs.unit.inlet.conc_mass_comp[0, "S_Mg"].fix(0.33787)

        # Alkalinity was givien in mg/L based on C
        m.fs.unit.inlet.alkalinity[0].fix(93.731)
    ...
    def test_solution(self, ElectroNP_frame):
        ...
        #     0.044, rel=1e-4
        # )
        assert value(m.fs.unit.electricity[0]) == pytest.approx(8.89269, rel=1e-4)
        assert value(m.fs.unit.MgCl2_flowrate[0]) == pytest.approx(78.417, rel=1e-4)
