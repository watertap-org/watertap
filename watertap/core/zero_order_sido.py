...
class SIDOBaseData(UnitModelBlockData):
    ...
    def build(self):
        ...
        def water_recovery_equation(b, t):
            return (
                b.recovery_vol[t] * b.properties_in[t].flow_vol
        ...
        def solute_treated_equation(b, t, j):
            return (
                (1 - b.removal_mass_solute[t, j]) * b.properties_in[t].conc_mass_comp[j]
    ...
    def calculate_scaling_factors(self):
        ...
        for t, v in self.flow_balance.items():
            iscale.constraint_scaling_transform(
                v,
                iscale.get_scaling_factor(
                    self.properties_in[t].flow_vol, default=1, warning=False
                ),
    ...
    def _get_stream_table_contents(self, time_point=0):
        return create_stream_table_dataframe(
            {"Inlet": self.inlet, "Treated": self.treated, "Byproduct": self.byproduct},
