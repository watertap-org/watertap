...
class ADM1ReactionParameterData(ReactionParameterBlock):
    ...
    def build(self):
        ...
        self.K_A_Bva = pyo.Var(
            initialize=1.1**8,
            units=(pyo.units.kmol / pyo.units.m**3) ** -1 * pyo.units.day**-1,
            domain=pyo.PositiveReals,
            doc="Ka_IN",
        )
        self.K_A_Bbu = pyo.Var(
            initialize=1.1**8,
            units=(pyo.units.kmol / pyo.units.m**3) ** -1 * pyo.units.day**-1,
            domain=pyo.PositiveReals,
            doc="KA_Bbu",
        )
        self.K_A_Bpro = pyo.Var(
            initialize=1.1**8,
            units=(pyo.units.kmol / pyo.units.m**3) ** -1 * pyo.units.day**-1,
            domain=pyo.PositiveReals,
            doc="KA_Bpro",
        )
        self.K_A_Bac = pyo.Var(
            initialize=1.1**8,
            units=(pyo.units.kmol / pyo.units.m**3) ** -1 * pyo.units.day**-1,
            domain=pyo.PositiveReals,
            doc="KA_Bac",
        )
        self.K_A_Bco2 = pyo.Var(
            initialize=1.1**8,
            units=(pyo.units.kmol / pyo.units.m**3) ** -1 * pyo.units.day**-1,
            domain=pyo.PositiveReals,
            doc="KA_Bco2",
        )
        self.K_A_BIN = pyo.Var(
            initialize=1.1**8,
            units=(pyo.units.kmol / pyo.units.m**3) ** -1 * pyo.units.day**-1,
            domain=pyo.PositiveReals,
            doc="KA_BIN",
