...
class TestReactor:
    ...
    def model(self):
        ...
        m.fs.R1.inlet.conc_mass_comp[0, "S_su"].fix(30 * units.mg / units.liter)
        m.fs.R1.inlet.conc_mass_comp[0, "S_aa"].fix(14.6112 * units.mg / units.liter)
        m.fs.R1.inlet.conc_mass_comp[0, "S_fa"].fix(1149 * units.mg / units.liter)
        m.fs.R1.inlet.conc_mass_comp[0, "S_va"].fix(89.324 * units.mg / units.liter)
        m.fs.R1.inlet.conc_mass_comp[0, "S_bu"].fix(2542.03 * units.mg / units.liter)
        m.fs.R1.inlet.conc_mass_comp[0, "S_pro"].fix(148.6 * units.mg / units.liter)
        m.fs.R1.inlet.conc_mass_comp[0, "S_ac"].fix(448 * units.mg / units.liter)
        m.fs.R1.inlet.conc_mass_comp[0, "S_h2"].fix(0.3928 * units.mg / units.liter)
        m.fs.R1.inlet.conc_mass_comp[0, "S_ch4"].fix(8.32 * units.mg / units.liter)
        m.fs.R1.inlet.conc_mass_comp[0, "S_IC"].fix(7.696 * units.mg / units.liter)
        m.fs.R1.inlet.conc_mass_comp[0, "S_IN"].fix(1.9404 * units.mg / units.liter)
        m.fs.R1.inlet.conc_mass_comp[0, "S_I"].fix(5.616 * units.mg / units.liter)

        m.fs.R1.inlet.conc_mass_comp[0, "X_c"].fix(30 * units.mg / units.liter)
        m.fs.R1.inlet.conc_mass_comp[0, "X_ch"].fix(14.6112 * units.mg / units.liter)
        m.fs.R1.inlet.conc_mass_comp[0, "X_pr"].fix(1149 * units.mg / units.liter)
        m.fs.R1.inlet.conc_mass_comp[0, "X_li"].fix(89.324 * units.mg / units.liter)
        m.fs.R1.inlet.conc_mass_comp[0, "X_su"].fix(2542.03 * units.mg / units.liter)
        m.fs.R1.inlet.conc_mass_comp[0, "X_aa"].fix(148.6 * units.mg / units.liter)
        m.fs.R1.inlet.conc_mass_comp[0, "X_fa"].fix(448 * units.mg / units.liter)
        m.fs.R1.inlet.conc_mass_comp[0, "X_c4"].fix(0.3928 * units.mg / units.liter)
        m.fs.R1.inlet.conc_mass_comp[0, "X_pro"].fix(8.32 * units.mg / units.liter)
        m.fs.R1.inlet.conc_mass_comp[0, "X_ac"].fix(7.696 * units.mg / units.liter)
        m.fs.R1.inlet.conc_mass_comp[0, "X_h2"].fix(1.9404 * units.mg / units.liter)
        m.fs.R1.inlet.conc_mass_comp[0, "X_I"].fix(5.616 * units.mg / units.liter)

        m.fs.R1.inlet.cations[0].fix(0.04 * units.mmol / units.liter)
        m.fs.R1.inlet.anions[0].fix(0.02 * units.mmol / units.liter)

        m.fs.R1.outlet.cations[0].fix(0.04 * units.mmol / units.liter)
        m.fs.R1.outlet.anions[0].fix(0.02 * units.mmol / units.liter)
