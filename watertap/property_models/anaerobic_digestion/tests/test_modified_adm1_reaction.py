...
class TestParamBlock(object):
    ...
    def test_build(self, model):
        ...
        stoic = {
            ...
            ("R4", "Liq", "S_ac"): 0.3690,
            ("R4", "Liq", "S_h2"): 0.1710,
            ("R4", "Liq", "S_IC"): 0.00718 * mw_c,
            ("R4", "Liq", "S_IN"): -0.00057 * mw_n,
            ("R4", "Liq", "X_su"): 0.10,
            ...
            ("R5", "Liq", "S_ac"): 0.3680,
            ("R5", "Liq", "S_h2"): 0.0552,
            ("R5", "Liq", "S_IC"): 0.00368 * mw_c,
            ("R5", "Liq", "S_IN"): 0.00654 * mw_n,
            ("R5", "Liq", "X_aa"): 0.08,
            # R6:  Uptake of long chain fatty acids (LCFAs)
            ("R6", "Liq", "S_fa"): -1,
            ("R6", "Liq", "S_ac"): 0.6580,
            ("R6", "Liq", "S_h2"): 0.2820,
            ("R6", "Liq", "S_IC"): -0.00068224 * mw_c,
            ("R6", "Liq", "S_IN"): -0.000342 * mw_n,
            ("R6", "Liq", "X_fa"): 0.06,
            ...
            ("R7", "Liq", "S_ac"): 0.2914,
            ("R7", "Liq", "S_h2"): 0.1410,
            ("R7", "Liq", "S_IC"): -0.00053371 * mw_c,
            ("R7", "Liq", "S_IN"): -0.0003428 * mw_n,
            ("R7", "Liq", "X_c4"): 0.06,
            # R8:  Uptake of butyrate
            ("R8", "Liq", "S_bu"): -1,
            ("R8", "Liq", "S_ac"): 0.7520,
            ("R8", "Liq", "S_h2"): 0.1880,
            ("R8", "Liq", "S_IC"): -0.00035613 * mw_c,
            ...
            ("R9", "Liq", "S_ac"): 0.5472,
            ("R9", "Liq", "S_h2"): 0.4128,
            ("R9", "Liq", "S_IN"): -0.0002285 * mw_n,
            ("R9", "Liq", "S_IC"): 0.008420 * mw_c,
            ("R9", "Liq", "X_pro"): 0.04,
            # R10: Uptake of acetate
            ("R10", "Liq", "S_ac"): -1,
            ("R10", "Liq", "S_ch4"): 0.95,
            ("R10", "Liq", "S_IN"): -0.0002857 * mw_n,
            ("R10", "Liq", "S_IC"): 0.01491 * mw_c,
            ("R10", "Liq", "X_ac"): 0.05,
            # R11: Uptake of hydrogen
            ("R11", "Liq", "S_h2"): -1,
            ("R11", "Liq", "S_ch4"): 0.94,
            ("R11", "Liq", "S_IN"): -0.0003428 * mw_n,
            # ("R11", "Liq", "S_IC"): -0.01654, #Todo this is real
            ("R11", "Liq", "S_IC"): -0.014663 * mw_c,
            ("R11", "Liq", "X_h2"): 0.06,
            # R12: Decay of X_su
            ("R12", "Liq", "S_IC"): 0.00344 * mw_c,
            ("R12", "Liq", "S_IN"): 0.003028 * mw_n,
            ("R12", "Liq", "X_c"): 1,
            ("R12", "Liq", "X_su"): -1,
            # R13: Decay of X_aa
