...
@declare_process_block_class("NewASM2dReactionParameterBlock")
class NewASM2dReactionParameterData(ReactionParameterBlock):
    """
    ...
    def build(self):
        ...
        self._reaction_block_class = NewASM2dReactionBlock
