...
from watertap.property_models.activated_sludge.new_modified_asm2d_reactions import (
    NewASM2dReactionParameterBlock,
    NewASM2dReactionBlock,
)
...
class TestParamBlock(object):
    ...
    def model(self):
        model = ConcreteModel()
        model.pparams = NewASM2dParameterBlock()
        model.rparams = NewASM2dReactionParameterBlock(property_package=model.pparams)

        return model

    @pytest.mark.unit
    def test_build(self, model):
        assert model.rparams.reaction_block_class is NewASM2dReactionBlock
...
class TestAerobic:
    ...
    def model(self):
        ...
        m.fs.props = NewASM2dParameterBlock()
        m.fs.rxn_props = NewASM2dReactionParameterBlock(property_package=m.fs.props)
