...
class NaClStateBlockData(StateBlockData):
    ...
    def _osm_coeff(self):
        self.osm_coeff = Var(
            initialize=1, bounds=(0.5, 2), units=pyunits.dimensionless, doc="Osmotic coefficient"
        )

        def rule_osm_coeff(b):
            return b.osm_coeff == (
                b.params.osm_coeff_param["2"] * b.mass_frac_phase_comp["Liq", "NaCl"] ** 2
    ...
    def calculate_scaling_factors(self):
        ...
        if self.is_property_constructed("flow_vol_phase"):
            ...
            iscale.set_scaling_factor(self.flow_vol_phase, sf * 10.0)
