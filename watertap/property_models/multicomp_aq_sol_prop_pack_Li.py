...
class MCASStateBlockData(StateBlockData):
    def build(self):
        ...
        #self.flow_mass_phase_comp = Var(
            ...
            #initialize={ ("Liq", "Li_+"): 0.00017, ("Liq", "Mg_2+"):0.00128, ("Liq", "Na_+"):0.0108, ("Liq", "Ca_2+"): 0.0004, ("Liq", "Cl_-"): 0.0194, ("Liq", "SO4_2-"): 0.0027, ("Liq", "OH_-"): 2.14e-5, ("Liq", "H_+"): 0.06, ("Liq", "H2-v"): 0.12, ("Liq", "O2-v"): 0.477}, #Keep adding initialized values!,
            #bounds=(0, None),
            #domain=NonNegativeReals,
    ...
    def _osm_coeff(self):
        ...
        def rule_osm_coeff(b, p):  # osmotic coefficient, eq. 49 in Sharqawy
            y1 = b.mass_frac_phase_comp[p, "Li_+"]
            y2 = b.mass_frac_phase_comp[p, "Ca_2+"]
            y3 = b.mass_frac_phase_comp[p, "Mg_2+"]
            y4 = b.mass_frac_phase_comp[p, "Cl_-"]
            y5 = b.mass_frac_phase_comp[p, "SO4_2-"]
            y6 = b.mass_frac_phase_comp[p, "Na_+"]
            newTDS = (y1, y2, y3, y4, y5, y6)
            s = sum(newTDS)
            t = (
    ...
    #     """Create enthalpy flow terms."""
    #     return self.enth_flow
    # Expirment: I use the specific enthalypy calculations from the seawater property package. 
    ...
    def _enth_mass_phase(self):
        ...
        def rule_enth_mass_phase(
                ...
                z1 = b.mass_frac_phase_comp[p, "Li_+"]
                z2 = b.mass_frac_phase_comp[p, "Ca_2+"]
                z3 = b.mass_frac_phase_comp[p, "Mg_2+"]
                z4 = b.mass_frac_phase_comp[p, "Cl_-"]
                z5 = b.mass_frac_phase_comp[p, "SO4_2-"]
                z6 = b.mass_frac_phase_comp[p, "Na_+"]
                newTDS = (z1, z2, z3, z4, z5, z6)
                S_kg_kg = sum(newTDS)
                S_g_kg = S_kg_kg * 1000
    ...
    def _enth_flow(self):
        # enthalpy flow expression for get enthalpy_flow_rate method
    ...
    def default_energy_balance_type(self):
        return EnergyBalanceType.useDefault
