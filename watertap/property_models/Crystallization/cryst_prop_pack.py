...
class NaClParameterData(PhysicalParameterBlock):
    ...
    CONFIG.declare("heat_of_crystallization_model", ConfigValue(
    ...
    def build(self):
       ...
       References
        ...
        self.dh_crystallization_param = Param(initialize=-520, units=enth_mass_units_2, doc='NaCl heat of crystallization')
        ...
        self.cp_param_NaCl_solid_A = Var(within=Reals, initialize=50.72389, units=cp_units_3, doc='Specific heat parameter A for solid NaCl')
        self.cp_param_NaCl_solid_B = Var(within=Reals, initialize=6.672267, units=cp_units_3/pyunits.K, doc='Specific heat parameter B for solid NaCl')
        ...
        self.pressure_sat_param_A2 = Var(within=Reals, initialize=-0.569e-3, units=pyunits.MPa, doc='Vapour pressure parameter A2')
        self.pressure_sat_param_A3 = Var(within=Reals, initialize=0.1945e-3, units=pyunits.MPa, doc='Vapour pressure parameter A3')
        self.pressure_sat_param_A4 = Var(within=Reals, initialize=-3.736e-3, units=pyunits.MPa, doc='Vapour pressure parameter A4')
        self.pressure_sat_param_A5 = Var(within=Reals, initialize=2.82e-3, units=pyunits.MPa, doc='Vapour pressure parameter A5')
        self.pressure_sat_param_B1 = Var(within=Reals, initialize=-0.0669e-3, units=pyunits.MPa/pyunits.K, doc='Vapour pressure parameter B1')
        self.pressure_sat_param_B2 = Var(within=Reals, initialize=0.0582e-3, units=pyunits.MPa/pyunits.K, doc='Vapour pressure parameter B2')
        self.pressure_sat_param_B3 = Var(within=Reals, initialize=-0.1668e-3, units=pyunits.MPa/pyunits.K, doc='Vapour pressure parameter B3')
        self.pressure_sat_param_B4 = Var(within=Reals, initialize=0.6761e-3, units=pyunits.MPa/pyunits.K, doc='Vapour pressure parameter B4')
        self.pressure_sat_param_B5 = Var(within=Reals, initialize=-2.091e-3, units=pyunits.MPa/pyunits.K, doc='Vapour pressure parameter B5')
        self.pressure_sat_param_C1 = Var(within=Reals, initialize=7.541e-6, units=pyunits.MPa/pyunits.K**2, doc='Vapour pressure parameter C1')
        self.pressure_sat_param_C2 = Var(within=Reals, initialize=-5.143e-6, units=pyunits.MPa/pyunits.K**2, doc='Vapour pressure parameter C2')
        self.pressure_sat_param_C3 = Var(within=Reals, initialize=6.482e-6, units=pyunits.MPa/pyunits.K**2, doc='Vapour pressure parameter C3')
        self.pressure_sat_param_C4 = Var(within=Reals, initialize=-52.62e-6, units=pyunits.MPa/pyunits.K**2, doc='Vapour pressure parameter C4')
        self.pressure_sat_param_C5 = Var(within=Reals, initialize=115.7e-6, units=pyunits.MPa/pyunits.K**2, doc='Vapour pressure parameter C5')
        self.pressure_sat_param_D1 = Var(within=Reals, initialize=-0.0922e-6, units=pyunits.MPa/pyunits.K**3, doc='Vapour pressure parameter D1')
        self.pressure_sat_param_D2 = Var(within=Reals, initialize=0.0649e-6, units=pyunits.MPa/pyunits.K**3, doc='Vapour pressure parameter D2')
        self.pressure_sat_param_D3 = Var(within=Reals, initialize=-0.1313e-6, units=pyunits.MPa/pyunits.K**3, doc='Vapour pressure parameter D3')
        self.pressure_sat_param_D4 = Var(within=Reals, initialize=0.8024e-6, units=pyunits.MPa/pyunits.K**3, doc='Vapour pressure parameter D4')
        self.pressure_sat_param_D5 = Var(within=Reals, initialize=-1.986e-6, units=pyunits.MPa/pyunits.K**3, doc='Vapour pressure parameter D5')
        self.pressure_sat_param_E1 = Var(within=Reals, initialize=1.237e-9, units=pyunits.MPa/pyunits.K**4, doc='Vapour pressure parameter E1')
        self.pressure_sat_param_E2 = Var(within=Reals, initialize=-0.753e-9, units=pyunits.MPa/pyunits.K**4, doc='Vapour pressure parameter E2')
        self.pressure_sat_param_E3 = Var(within=Reals, initialize=0.1448e-9, units=pyunits.MPa/pyunits.K**4, doc='Vapour pressure parameter E3')
        self.pressure_sat_param_E4 = Var(within=Reals, initialize=-6.964e-9, units=pyunits.MPa/pyunits.K**4, doc='Vapour pressure parameter E4')
        self.pressure_sat_param_E5 = Var(within=Reals, initialize=14.61e-9, units=pyunits.MPa/pyunits.K**4, doc='Vapour pressure parameter E5')

        # Parameters for saturation temperature of water vapour from eq. A.12 in El-Dessouky and Ettouney
        self.temp_sat_solvent_A1 = Var(within=Reals, initialize=42.6776, units=pyunits.K, doc='Water boiling point parameter A1')
        self.temp_sat_solvent_A2 = Var(within=Reals, initialize=-3892.7, units=pyunits.K, doc='Water boiling point parameter A2')
        self.temp_sat_solvent_A3 = Var(within=Reals, initialize=1000, units=pyunits.kPa, doc='Water boiling point parameter A3')
        self.temp_sat_solvent_A4 = Var(within=Reals, initialize=-9.48654, units=pyunits.dimensionless, doc='Water boiling point parameter A4')

        # Parameters for specific enthalpy of pure water in liquid phase from eq. 55 in Sharqawy et al. (2010)
        self.enth_mass_solvent_param_A1 = Var(within=Reals, initialize=141.355, units=enth_mass_units, doc='Specific enthalpy parameter A1')
        self.enth_mass_solvent_param_A2 = Var(within=Reals, initialize=4202.07, units=enth_mass_units * t_inv_units, doc='Specific enthalpy parameter A2')
        self.enth_mass_solvent_param_A3 = Var(within=Reals, initialize=-0.535, units=enth_mass_units * t_inv_units**2, doc='Specific enthalpy parameter A3')
        self.enth_mass_solvent_param_A4 = Var(within=Reals, initialize=0.004, units=enth_mass_units * t_inv_units**3, doc='Specific enthalpy parameter A4')

        # Enthalpy parameters for NaCl solution from Sparrow (2003): 0 < T < 300 degC
        self.enth_phase_param_A1 = Var(within=Reals, initialize=0.0005e3, units=enth_mass_units_2, doc='Solution enthalpy parameter A1')
        self.enth_phase_param_A2 = Var(within=Reals, initialize=0.0378e3, units=enth_mass_units_2, doc='Solution enthalpy parameter A2')
        self.enth_phase_param_A3 = Var(within=Reals, initialize=-0.3682e3, units=enth_mass_units_2, doc='Solution enthalpy parameter A3')
        self.enth_phase_param_A4 = Var(within=Reals, initialize=-0.6529e3, units=enth_mass_units_2, doc='Solution enthalpy parameter A4')
        self.enth_phase_param_A5 = Var(within=Reals, initialize=2.89e3, units=enth_mass_units_2, doc='Solution enthalpy parameter A5')
        self.enth_phase_param_B1 = Var(within=Reals, initialize=4.145, units=enth_mass_units_2/pyunits.K, doc='Solution enthalpy parameter B1')
        self.enth_phase_param_B2 = Var(within=Reals, initialize=-4.973, units=enth_mass_units_2/pyunits.K, doc='Solution enthalpy parameter B2')
        self.enth_phase_param_B3 = Var(within=Reals, initialize=4.482, units=enth_mass_units_2/pyunits.K, doc='Solution enthalpy parameter B3')
        self.enth_phase_param_B4 = Var(within=Reals, initialize=18.31, units=enth_mass_units_2/pyunits.K, doc='Solution enthalpy parameter B4')
        self.enth_phase_param_B5 = Var(within=Reals, initialize=-46.41, units=enth_mass_units_2/pyunits.K, doc='Solution enthalpy parameter B5')
        self.enth_phase_param_C1 = Var(within=Reals, initialize=0.0007, units=enth_mass_units_2/pyunits.K**2, doc='Solution enthalpy parameter C1')
        self.enth_phase_param_C2 = Var(within=Reals, initialize=-0.0059, units=enth_mass_units_2/pyunits.K**2, doc='Solution enthalpy parameter C2')
        self.enth_phase_param_C3 = Var(within=Reals, initialize=0.0854, units=enth_mass_units_2/pyunits.K**2, doc='Solution enthalpy parameter C3')
        self.enth_phase_param_C4 = Var(within=Reals, initialize=-0.4951, units=enth_mass_units_2/pyunits.K**2, doc='Solution enthalpy parameter C4')
        self.enth_phase_param_C5 = Var(within=Reals, initialize=0.8255, units=enth_mass_units_2/pyunits.K**2, doc='Solution enthalpy parameter C5')
        self.enth_phase_param_D1 = Var(within=Reals, initialize=-0.0048e-3, units=enth_mass_units_2/pyunits.K**3, doc='Solution enthalpy parameter D1')
        self.enth_phase_param_D2 = Var(within=Reals, initialize=0.0639e-3, units=enth_mass_units_2/pyunits.K**3, doc='Solution enthalpy parameter D2')
        self.enth_phase_param_D3 = Var(within=Reals, initialize=-0.714e-3, units=enth_mass_units_2/pyunits.K**3, doc='Solution enthalpy parameter D3')
        self.enth_phase_param_D4 = Var(within=Reals, initialize=3.273e-3, units=enth_mass_units_2/pyunits.K**3, doc='Solution enthalpy parameter D4')
        self.enth_phase_param_D5 = Var(within=Reals, initialize=-4.85e-3, units=enth_mass_units_2/pyunits.K**3, doc='Solution enthalpy parameter D5')
        self.enth_phase_param_E1 = Var(within=Reals, initialize=0.0202e-6, units=enth_mass_units_2/pyunits.K**4, doc='Solution enthalpy parameter E1')
        self.enth_phase_param_E2 = Var(within=Reals, initialize=-0.2432e-6, units=enth_mass_units_2/pyunits.K**4, doc='Solution enthalpy parameter E2')
        self.enth_phase_param_E3 = Var(within=Reals, initialize=2.054e-6, units=enth_mass_units_2/pyunits.K**4, doc='Solution enthalpy parameter E3')
...
class NaClStateBlockData(StateBlockData):
    ...
    def _cp_solute(self):
        ...
        def rule_cp_solute(b, p):  
            if p == 'Sol': # Shomate equation for NaCl, NIST
                ...
                cp_solute_mol = b.params.cp_param_NaCl_solid_A + (b.params.cp_param_NaCl_solid_B * t) + \
    ...
    def _pressure_sat(self):
        ...
        def rule_pressure_sat(b):  # vapor pressure, eq6 in Sparrow (2003)
            ...
            ps_a = b.params.pressure_sat_param_A1 + (b.params.pressure_sat_param_A2 * x) + \
                (b.params.pressure_sat_param_A3 * x**2) + (b.params.pressure_sat_param_A4 * x**3) + \
                (b.params.pressure_sat_param_A5 * x**4)

            ps_b = b.params.pressure_sat_param_B1 + (b.params.pressure_sat_param_B2 * x) + \
                (b.params.pressure_sat_param_B3 * x**2) + (b.params.pressure_sat_param_B4 * x**3) + \
                (b.params.pressure_sat_param_B5 * x**4)

            ps_c = b.params.pressure_sat_param_C1 + (b.params.pressure_sat_param_C2 * x) + \
                (b.params.pressure_sat_param_C3 * x**2) + (b.params.pressure_sat_param_C4 * x**3) + \
                (b.params.pressure_sat_param_C5 * x**4)

            ps_d = b.params.pressure_sat_param_D1 + (b.params.pressure_sat_param_D2 * x) + \
                (b.params.pressure_sat_param_D3 * x**2) + (b.params.pressure_sat_param_D4 * x**3) + \
                (b.params.pressure_sat_param_D5 * x**4)

            ps_e = b.params.pressure_sat_param_E1 + (b.params.pressure_sat_param_E2 * x) + \
                (b.params.pressure_sat_param_E3 * x**2) + (b.params.pressure_sat_param_E4 * x**3) + \
                (b.params.pressure_sat_param_E5 * x**4)

            p_sat = ps_a + (ps_b * t) + (ps_c * t ** 2) + (ps_d * t ** 3) + (ps_e * t **4)
            return (
                b.pressure_sat == pyunits.convert(p_sat, to_units=pyunits.Pa)
                )
    ...
    def _temperature_sat_solvent(self):
        ...
        def rule_temperature_sat_solvent(b):
            ...
            return ( 
                b.temperature_sat_solvent ==  b.params.temp_sat_solvent_A1 + \
                b.params.temp_sat_solvent_A2 / (log(psat / b.params.temp_sat_solvent_A3) + b.params.temp_sat_solvent_A4) 
                )
    ...
    def _enth_mass_solvent(self):
        ...
        def rule_enth_mass_solvent(b, p):
            t = b.temperature - 273.15*pyunits.K
            h_w = (b.params.enth_mass_solvent_param_A1
    ...
    def _enth_mass_phase(self):
        ...
        def rule_enth_mass_phase(b):  # specific enthalpy calculation based on Sparrow (2003).
            t = b.temperature - 273.15 * pyunits.K  # temperature in degC, but pyunits in K
            S = b.mass_frac_phase_comp['Liq', 'NaCl']
    
            enth_a = b.params.enth_phase_param_A1 + (b.params.enth_phase_param_A2 * S) + \
                (b.params.enth_phase_param_A3 * S**2) + (b.params.enth_phase_param_A4 * S**3) + \
                (b.params.enth_phase_param_A5 * S**4)

            enth_b = b.params.enth_phase_param_B1 + (b.params.enth_phase_param_B2 * S) + \
                (b.params.enth_phase_param_B3 * S**2) + (b.params.enth_phase_param_B4 * S**3) + \
                (b.params.enth_phase_param_B5 * S**4)

            enth_c = b.params.enth_phase_param_C1 + (b.params.enth_phase_param_C2 * S) + \
                (b.params.enth_phase_param_C3 * S**2) + (b.params.enth_phase_param_C4 * S**3) + \
                (b.params.enth_phase_param_C5 * S**4)

            enth_d = b.params.enth_phase_param_D1 + (b.params.enth_phase_param_D2 * S) + \
                (b.params.enth_phase_param_D3 * S**2) + (b.params.enth_phase_param_D4 * S**3) + \
                (b.params.enth_phase_param_D5 * S**4)

            enth_e = b.params.enth_phase_param_E1 + (b.params.enth_phase_param_E2 * S) + \
                (b.params.enth_phase_param_E3 * S**2) + (b.params.enth_phase_param_E4 * S**3) + \
                (b.params.enth_phase_param_E5 * S**4)

            return (
                b.enth_mass_phase['Liq'] == enth_a  + (enth_b * t) + (enth_c * t ** 2) + (enth_d * t ** 3) + (enth_e * t **4)
                )
    ...
    def _dh_crystallization(self):
        ...
        def rule_dh_crystallization(b):
            if b.params.config.heat_of_crystallization_model == HeatOfCrystallizationModel.constant:
                return b.dh_crystallization['NaCl'] == b.params.dh_crystallization_param
            elif b.params.config.heat_of_crystallization_model == HeatOfCrystallizationModel.zero:
                return b.dh_crystallization['NaCl'] == 0 * pyunits.kJ/pyunits.kg
            elif b.params.config.heat_of_crystallization_model == HeatOfCrystallizationModel.temp_dependent:
                raise NotImplementedError(f"Temperature-dependent heat of crystallization model has not been implemented yet.")
    ...
    def calculate_scaling_factors(self):
        ...
        if iscale.get_scaling_factor(self.flow_mass_phase_comp['Sol', 'NaCl']) is None:
            sf = iscale.get_scaling_factor(self.flow_mass_phase_comp['Sol', 'NaCl'], default=1e2, warning=True)
        ...
        if iscale.get_scaling_factor(self.flow_mass_phase_comp['Vap', 'H2O']) is None:
            sf = iscale.get_scaling_factor(self.flow_mass_phase_comp['Vap', 'H2O'], default=1e0, warning=True)
            iscale.set_scaling_factor(self.flow_mass_phase_comp['Vap', 'H2O'], sf)

        # This flow is always zero - no H2O in solid phase
        if iscale.get_scaling_factor(self.flow_mass_phase_comp['Sol', 'H2O']) is None:
            sf = iscale.get_scaling_factor(self.flow_mass_phase_comp['Sol', 'H2O'], default=1e0)
            iscale.set_scaling_factor(self.flow_mass_phase_comp['Sol', 'H2O'], sf)

        # This flow is always zero - no NaCl in vapour phase
        if iscale.get_scaling_factor(self.flow_mass_phase_comp['Vap', 'NaCl']) is None:
            sf = iscale.get_scaling_factor(self.flow_mass_phase_comp['Vap', 'NaCl'], default=1e0)
            iscale.set_scaling_factor(self.flow_mass_phase_comp['Vap', 'NaCl'], sf)
        ...
        if self.is_property_constructed('flow_vol_phase'):
            for p in self.params.phase_list:
                if p == 'Liq':
                    ...
                    if iscale.get_scaling_factor(self.flow_vol_phase[p]) is None:
                        sf = (iscale.get_scaling_factor(self.flow_mass_phase_comp[p, 'NaCl'])
