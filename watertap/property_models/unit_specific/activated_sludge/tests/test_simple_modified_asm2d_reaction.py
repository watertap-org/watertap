...
from watertap.property_models.unit_specific.activated_sludge.simple_modified_asm2d_reactions import (
    SimpleModifiedASM2dReactionParameterBlock,
    SimpleModifiedASM2dReactionBlock,
)
...
class TestParamBlock(object):
    ...
    def model(self):
        model = ConcreteModel()
        model.pparams = SimpleModifiedASM2dParameterBlock(
            additional_solute_list=["S_K", "S_Mg"]
        )
        model.rparams = SimpleModifiedASM2dReactionParameterBlock(
    ...
    def test_build(self, model):
        assert model.rparams.reaction_block_class is SimpleModifiedASM2dReactionBlock
...
class TestAerobic:
    ...
    def model(self):
        ...
        m.fs.props = SimpleModifiedASM2dParameterBlock(
            additional_solute_list=["S_K", "S_Mg"]
        )
        m.fs.rxn_props = SimpleModifiedASM2dReactionParameterBlock(
