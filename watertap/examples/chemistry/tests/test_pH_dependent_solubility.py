...
from idaes.generic_models.properties.core.reactions.equilibrium_constant import ConstantKeq

# Import specific pyomo objects
from pyomo.environ import ConcreteModel, SolverStatus, TerminationCondition, value, Suffix
...
case1_log_rxn_config = {
    ...
    "equilibrium_reactions": {
        "CaOH2_Ksp": {
            "stoichiometry": {("Sol", "Ca(OH)2"): -1, ("Liq", "Ca_2+"): 1, ("Liq", "OH_-"): 2},
            ...
            "parameter_data": {
                ...
                "reaction_order": {("Sol", "Ca(OH)2"): 0, ("Liq", "Ca_2+"): 1, ("Liq", "OH_-"): 2},
            }
            # End parameter_data
        },
        "H2O_Kw": {
    ...
    for i in unit.control_volume.equilibrium_reaction_extent_index:
        ...
        if rxn_config["equilibrium_reactions"][i[1]]["equilibrium_form"] == solubility_product:
            iscale.set_scaling_factor(
                unit.control_volume.equilibrium_reaction_extent[0.0, i[1]], 1e-1 / scale
            )
...
def run_case1(
    ...
    for i in model.fs.unit.control_volume.properties_out[0.0].mole_frac_comp:
        print(
            str(i)
            + "\t"
            + str(value(model.fs.unit.control_volume.properties_out[0.0].mole_frac_comp[i]))
        )
    print()
    ...
    for i in model.fs.unit.control_volume.properties_out[0.0].mole_frac_phase_comp:
        print(
            str(i)
            + "\t"
            + str(value(model.fs.unit.control_volume.properties_out[0.0].mole_frac_phase_comp[i]))
        )
    print()

    Ca = value(
        model.fs.unit.control_volume.properties_out[0.0].mole_frac_phase_comp["Liq", "Ca_2+"]
    )
...
case2_log_rxn_config = {
    ...
    "equilibrium_reactions": {
        "CaCO3_Ksp": {
            "stoichiometry": {("Sol", "CaCO3"): -1, ("Liq", "Ca_2+"): 1, ("Liq", "CO3_2-"): 1},
            "heat_of_reaction": constant_dh_rxn,
            "equilibrium_constant": van_t_hoff,
            "equilibrium_form": log_solubility_product,
            "concentration_form": ConcentrationForm.moleFraction,
            "parameter_data": {
                ...
                "T_eq_ref": (298.0, pyunits.K),
                "reaction_order": {("Sol", "CaCO3"): 0, ("Liq", "Ca_2+"): 1, ("Liq", "CO3_2-"): 1},
            }
            # End parameter_data
        },
        "H2O_Kw": {
...
def run_case2(
    ...
    H = value(model.fs.unit.control_volume.properties_out[0.0].mole_frac_phase_comp["Liq", "H_+"])
    CO3 = value(
        model.fs.unit.control_volume.properties_out[0.0].mole_frac_phase_comp["Liq", "CO3_2-"]
    )
...
case4_log_rxn_config = {
    ...
    "equilibrium_reactions": {
        "FePO4_Ksp": {
            "stoichiometry": {("Sol", "FePO4"): -1, ("Liq", "Fe_3+"): 1, ("Liq", "PO4_3-"): 1},
            "heat_of_reaction": constant_dh_rxn,
            "equilibrium_constant": van_t_hoff,
            "equilibrium_form": log_solubility_product,
            "concentration_form": ConcentrationForm.moleFraction,
            "parameter_data": {
                ...
                "T_eq_ref": (298.0, pyunits.K),
                "reaction_order": {("Sol", "FePO4"): 0, ("Liq", "Fe_3+"): 1, ("Liq", "PO4_3-"): 1},
            }
            # End parameter_data
        },
        "H2O_Kw": {
        ...
        "H3PO4_Ka2": {
            "stoichiometry": {("Liq", "H2PO4_-"): -1, ("Liq", "H_+"): 1, ("Liq", "HPO4_2-"): 1},
            "heat_of_reaction": constant_dh_rxn,
            "equilibrium_constant": van_t_hoff,
            "equilibrium_form": log_power_law_equil,
            "concentration_form": ConcentrationForm.moleFraction,
        ...
        "H3PO4_Ka3": {
            "stoichiometry": {("Liq", "HPO4_2-"): -1, ("Liq", "H_+"): 1, ("Liq", "PO4_3-"): 1},
            "heat_of_reaction": constant_dh_rxn,
            "equilibrium_constant": van_t_hoff,
            "equilibrium_form": log_power_law_equil,
            "concentration_form": ConcentrationForm.moleFraction,
            "parameter_data": {
                ...
                # By default, reaction orders follow stoichiometry
                #    manually set reaction order here to override
                "reaction_order": {("Liq", "HPO4_2-"): -1, ("Liq", "H_+"): 1, ("Liq", "PO4_3-"): 1},
            }
            # End parameter_data
        },
        "FeOH_K": {
            "stoichiometry": {("Liq", "FeOH_2+"): -1, ("Liq", "Fe_3+"): 1, ("Liq", "OH_-"): 1},
            "heat_of_reaction": constant_dh_rxn,
            "equilibrium_constant": van_t_hoff,
            "equilibrium_form": log_power_law_equil,
            "concentration_form": ConcentrationForm.moleFraction,
            "parameter_data": {
                ...
                # By default, reaction orders follow stoichiometry
                #    manually set reaction order here to override
                "reaction_order": {("Liq", "FeOH_2+"): -1, ("Liq", "Fe_3+"): 1, ("Liq", "OH_-"): 1},
            }
            # End parameter_data
        },
        "FeOH2_K": {
            "stoichiometry": {("Liq", "Fe(OH)2_+"): -1, ("Liq", "FeOH_2+"): 1, ("Liq", "OH_-"): 1},
            "heat_of_reaction": constant_dh_rxn,
            "equilibrium_constant": van_t_hoff,
            "equilibrium_form": log_power_law_equil,
            "concentration_form": ConcentrationForm.moleFraction,
        ...
        "FeOH3_K": {
            "stoichiometry": {("Liq", "Fe(OH)3"): -1, ("Liq", "Fe(OH)2_+"): 1, ("Liq", "OH_-"): 1},
            "heat_of_reaction": constant_dh_rxn,
            "equilibrium_constant": van_t_hoff,
            "equilibrium_form": log_power_law_equil,
            "concentration_form": ConcentrationForm.moleFraction,
        ...
        "FeOH4_K": {
            "stoichiometry": {("Liq", "Fe(OH)4_-"): -1, ("Liq", "Fe(OH)3"): 1, ("Liq", "OH_-"): 1},
            "heat_of_reaction": constant_dh_rxn,
            "equilibrium_constant": van_t_hoff,
            "equilibrium_form": log_power_law_equil,
            "concentration_form": ConcentrationForm.moleFraction,
...
def run_case4(
    ...
    Fe = value(
        model.fs.unit.control_volume.properties_out[0.0].mole_frac_phase_comp["Liq", "Fe_3+"]
    )
    OH = value(model.fs.unit.control_volume.properties_out[0.0].mole_frac_phase_comp["Liq", "OH_-"])
    H = value(model.fs.unit.control_volume.properties_out[0.0].mole_frac_phase_comp["Liq", "H_+"])
    PO4 = value(
        model.fs.unit.control_volume.properties_out[0.0].mole_frac_phase_comp["Liq", "PO4_3-"]
    )
