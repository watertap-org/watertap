...
def run_case2(xA, xB, xAB=1e-25, scaling=True, scaling_ref=1e-3, rxn_config=None, state="FpcTP"):
    print("==========================================================================")
    print(
...
def test_case2_mid_conc_no_precipitation():
    model = run_case2(
        xA=1e-9, xB=1e-2, xAB=1e-25, scaling=True, scaling_ref=1e-5, rxn_config=reaction_log_solubility
    )
