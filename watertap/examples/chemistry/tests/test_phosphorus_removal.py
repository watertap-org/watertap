...
thermo_config = {
    ...
    "inherent_reactions": {
        ...
        # End R11
        "FePO4_Ksp": {
            "stoichiometry": {("Liq", "FePO4(s)"): -1, ("Liq", "Fe_3+"): 1, ("Liq", "PO4_3-"): 1},
            "heat_of_reaction": constant_dh_rxn,
            "equilibrium_constant": van_t_hoff,
            "equilibrium_form": log_power_law_equil,
            "concentration_form": ConcentrationForm.moleFraction,
...
class TestSimplePhosphorusRemoval:
    ...
    def simple_phosphorus_removal(self):
        ...
        total_iron_inlet += (
            1e-4  # mol/L (additional iron added for phosphorus removal) [Added as FeCl3]
        )
    ...
    def test_solution_simple_phosphorus_removal(self, simple_phosphorus_removal):
        ...
        carbonate_alk = (
            value(model.fs.unit.outlet.mole_frac_comp[0, "HCO3_-"]) * total_molar_density
        )
        carbonate_alk += (
            2 * value(model.fs.unit.outlet.mole_frac_comp[0, "CO3_2-"]) * total_molar_density
        )
        ...
        total_phosphorus = (
            value(model.fs.unit.outlet.mole_frac_comp[0, "H3PO4"]) * total_molar_density
        )
        total_phosphorus += (
            value(model.fs.unit.outlet.mole_frac_comp[0, "H2PO4_-"]) * total_molar_density
        )
        total_phosphorus += (
            value(model.fs.unit.outlet.mole_frac_comp[0, "HPO4_2-"]) * total_molar_density
        )
        total_phosphorus += (
            value(model.fs.unit.outlet.mole_frac_comp[0, "PO4_3-"]) * total_molar_density
        )
        total_phosphorus += (
            value(model.fs.unit.outlet.mole_frac_comp[0, "FeHPO4_+"]) * total_molar_density
        )
        total_phosphorus += (
            value(model.fs.unit.outlet.mole_frac_comp[0, "FeH2PO4_2+"]) * total_molar_density
        )
        total_phosphorus = total_phosphorus * 95000

        phos_precip = (
            value(model.fs.unit.outlet.mole_frac_comp[0, "FePO4(s)"]) * total_molar_density
        )
        ...
        total_iron += (
            value(model.fs.unit.outlet.mole_frac_comp[0, "Fe(OH)2_+"]) * total_molar_density
        )
        total_iron += value(model.fs.unit.outlet.mole_frac_comp[0, "Fe(OH)3"]) * total_molar_density
        total_iron += (
            value(model.fs.unit.outlet.mole_frac_comp[0, "Fe(OH)4_-"]) * total_molar_density
        )
        total_iron += (
            value(model.fs.unit.outlet.mole_frac_comp[0, "FeHPO4_+"]) * total_molar_density
        )
