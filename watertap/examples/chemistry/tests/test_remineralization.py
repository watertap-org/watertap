...
from idaes.core import AqueousPhase, EnergyBalanceType, FlowsheetBlock
...
class TestRemineralization:
    ...
    def test_validation_appr_equ(self, remineralization_appr_equ):
        ...
        nahco3 = value(
            model.fs.unit.control_volume.properties_out[
                0.0
            ].mole_frac_phase_comp_apparent["Liq", "NaHCO3"]
        )
        ...
        h2co3 = value(
            model.fs.unit.control_volume.properties_out[
                0.0
            ].mole_frac_phase_comp_apparent["Liq", "H2CO3"]
        )
        ...
        caoh = value(
            model.fs.unit.control_volume.properties_out[
                0.0
            ].mole_frac_phase_comp_apparent["Liq", "Ca(OH)2"]
        )
        ...
        naoh = value(
            model.fs.unit.control_volume.properties_out[
                0.0
            ].mole_frac_phase_comp_apparent["Liq", "NaOH"]
        )
        ...
        caco3 = value(
            model.fs.unit.control_volume.properties_out[
                0.0
            ].mole_frac_phase_comp_apparent["Liq", "CaCO3"]
        )
        ...
        cahco3 = value(
            model.fs.unit.control_volume.properties_out[
                0.0
            ].mole_frac_phase_comp_apparent["Liq", "Ca(HCO3)2"]
        )
