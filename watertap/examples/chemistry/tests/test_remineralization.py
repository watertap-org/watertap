...
class TestRemineralization:
    ...
    def test_validation_appr_equ(self, remineralization_appr_equ):
        ...
        nahco3 = value(
            model.fs.unit.control_volume.properties_out[0.0].mole_frac_phase_comp_apparent[
                "Liq", "NaHCO3"
            ]
        )
...
reaction_config_cstr = {
    ...
    "rate_reactions": {
        "R1": {
            "stoichiometry": {("Liq", "NaHCO3"): -1, ("Liq", "HCO3_-"): 1, ("Liq", "Na_+"): 1},
            "heat_of_reaction": constant_dh_rxn,
        ...
        "R2": {
            "stoichiometry": {("Liq", "Ca(OH)2"): -1, ("Liq", "OH_-"): 2, ("Liq", "Ca_2+"): 1},
            "heat_of_reaction": constant_dh_rxn,
            "rate_constant": arrhenius,
            "rate_form": power_law_rate,
            "concentration_form": ConcentrationForm.moleFraction,
...
class TestRemineralizationCSTR:
    ...
    def test_scaling_cstr_kin(self, remineralization_cstr_kin):
        ...
        for i in model.fs.rxn_params.rate_reaction_idx:
            ...
            iscale.set_scaling_factor(
                model.fs.unit.control_volume.rate_reaction_extent[0.0, i], 10 / scale
            )
