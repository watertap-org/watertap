...
from idaes.core.util.scaling import unscaled_variables_generator, unscaled_constraints_generator
...
class TestEnergyRecoverySystem:
    ...
    def test_set_operating_conditions(self, system_frame):
        ...
        assert value(m.fs.P1.control_volume.properties_out[0].pressure) == pytest.approx(
            7.493e6, rel=1e-3
        )
