...
def export_variables(model=None, exports=None, build_options=None, **kwargs):
    ...
    exports.add(
        obj=model.fs.feed.conc_mass_comp[0, "peracetic_acid"],
    ...
    exports.add(
        obj=model.fs.feed.conc_mass_comp[0, "total_coliforms_fecal_ecoli"],
    ...
    exports.add(
        obj=model.fs.PAA.recovery_frac_mass_H2O[0],
        name="Water recovery",
    ...
    exports.add(
        obj=model.fs.PAA.reaction_conversion[0, "paa_decomposition"],
    ...
    exports.add(
        obj=model.fs.PAA.reaction_conversion[0, "ecoli_inactivation"],
    ...
    exports.add(
        obj=model.fs.PAA.energy_electric_flow_vol_inlet,
    ...
    exports.add(
        obj=model.fs.PAA.ecoli_cell_mass,
        name="Ecoli mass",
        ui_units=pyunits.kg,
        display_units="kg",
        rounding=16,
    ...
    exports.add(
        obj=model.fs.PAA.disinfection_solution_wt_frac_PAA,
    ...
    exports.add(
        obj=model.fs.PAA.disinfection_solution_density,
    ...
    exports.add(
        obj=model.fs.costing.peracetic_acid_disinfection.sizing_cost[None],
    ...
    exports.add(
        obj=model.fs.costing.disinfection_solution_cost,
        name="Disinfection solution cost",
        ui_units=model.fs.costing.base_currency / pyunits.gal,
        display_units="$/gal",
        rounding=3,
    ...
    # Outlets
    exports.add(
        obj=model.fs.treated_water.properties[0].flow_vol,
    ...
    exports.add(
        obj=model.fs.treated_water.properties[0].conc_mass_comp["peracetic_acid"],
    ...
    exports.add(
        obj=model.fs.treated_water.properties[0].conc_mass_comp[
    ...
    direct_capital_norm = (
        model.fs.PAA.costing.direct_capital_cost
    ...
    # performance metrics
    recovery_vol = (
        model.fs.treated_water.properties[0].flow_vol
        / model.fs.feed.properties[0].flow_vol
    )
    exports.add(
        obj=recovery_vol,
    ...
    removal_PAA = (
        1
        - model.fs.treated_water.properties[0].flow_mass_comp["peracetic_acid"]
        / model.fs.feed.properties[0].flow_mass_comp["peracetic_acid"]
    )
    exports.add(
        obj=removal_PAA,
        name="PAA removal",
    ...
    removal_Ecoli = (
        1
        - model.fs.treated_water.properties[0].flow_mass_comp[
            "total_coliforms_fecal_ecoli"
        ]
        / model.fs.feed.properties[0].flow_mass_comp["total_coliforms_fecal_ecoli"]
    )
    exports.add(
        obj=removal_Ecoli,
        name="Ecoli removal",
    ...
    exports.add(
        obj=model.fs.PAA.costing.capital_cost,
        name="Peracetic acid disinfection",
        ui_units=model.fs.costing.base_currency,
        display_units="$",
        rounding=0,
