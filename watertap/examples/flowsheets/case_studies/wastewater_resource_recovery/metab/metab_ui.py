...
def export_variables(model=None, exports=None, build_options=None, **kwargs):
    ...
    exports.add(
        obj=model.fs.metab_hydrogen.recovery_frac_mass_H2O[0],
        name="Water recovery",
    ...
    exports.add(
        obj=model.fs.metab_hydrogen.reaction_conversion[0, "cod_to_hydrogen"],
        name="COD conversion",
        ui_units=pyunits.dimensionless,
        display_units="fraction",  # we should change to %
        rounding=2,
    ...
    exports.add(
        obj=model.fs.metab_hydrogen.generation_ratio["cod_to_hydrogen", "hydrogen"],
    ...
    exports.add(
        obj=model.fs.metab_hydrogen.hydraulic_retention_time,
        name="HRT",
        ui_units=pyunits.hr,
        display_units="h",
        rounding=1,
    ...
    exports.add(
        obj=model.fs.metab_hydrogen.energy_electric_mixer_vol,
    ...
    exports.add(
        obj=model.fs.metab_hydrogen.energy_electric_vacuum_flow_vol_byproduct,
    ...
    exports.add(
        obj=model.fs.metab_hydrogen.energy_thermal_flow_vol_inlet,
    ...
    exports.add(
        obj=model.fs.costing.metab.bead_bulk_density["hydrogen"],
    ...
    exports.add(
        obj=model.fs.costing.metab.reactor_cost["hydrogen"],
        name="Reactor cost",
    ...
    exports.add(
        obj=model.fs.costing.metab.mixer_cost["hydrogen"],
        name="Mixer cost",
        ui_units=model.fs.costing.base_currency / pyunits.kW,
    ...
    exports.add(
        obj=model.fs.costing.metab.bead_cost["hydrogen"],
        name="Bead cost",
    ...
    exports.add(
        obj=model.fs.costing.metab.bead_replacement_factor["hydrogen"],
    ...
    exports.add(
        obj=model.fs.costing.metab.membrane_sidestream_fraction["hydrogen"],
    ...
    exports.add(
        obj=model.fs.costing.metab.membrane_specific_size["hydrogen"],
    ...
    exports.add(
        obj=model.fs.costing.metab.membrane_cost["hydrogen"],
        name="Membrane cost",
    ...
    exports.add(
        obj=model.fs.costing.metab.vacuum_cost["hydrogen"],
        name="Vacuum cost",
        ui_units=model.fs.costing.base_currency / (pyunits.kg / pyunits.hr),
    ...
    exports.add(
        obj=model.fs.metab_methane.recovery_frac_mass_H2O[0],
        name="Water recovery",
        ui_units=pyunits.dimensionless,
        display_units="fraction",  # we should change to %
        rounding=2,
    ...
    exports.add(
        obj=model.fs.metab_methane.reaction_conversion[0, "cod_to_methane"],
        name="COD conversion",
        ui_units=pyunits.dimensionless,
        display_units="fraction",  # we should change to %
        rounding=2,
    ...
    exports.add(
        obj=model.fs.metab_methane.generation_ratio["cod_to_methane", "methane"],
    ...
    exports.add(
        obj=model.fs.metab_methane.hydraulic_retention_time,
        name="HRT",
        ui_units=pyunits.hr,
        display_units="h",
        rounding=1,
    ...
    exports.add(
        obj=model.fs.metab_methane.energy_electric_mixer_vol,
        name="Mixer specific power",
        ui_units=pyunits.kW / pyunits.m**3,
        display_units="kW/m3 of reactor",
        rounding=3,
    ...
    exports.add(
        obj=model.fs.metab_methane.energy_electric_vacuum_flow_vol_byproduct,
        name="Vacuum specific power",
        ui_units=pyunits.kW / (pyunits.kg / pyunits.hr),
        display_units="kW/(kg-H2/h)",
        rounding=2,
    ...
    exports.add(
        obj=model.fs.metab_methane.energy_thermal_flow_vol_inlet,
        name="Specific heating",
        ui_units=pyunits.MJ / pyunits.m**3,
        display_units="MJ/m3 of water",
        rounding=2,
    ...
    exports.add(
        obj=model.fs.costing.metab.bead_bulk_density["methane"],
        name="Bead bulk density",
        ui_units=pyunits.kg / pyunits.m**3,
        display_units="kg/m3 of reactor",
        rounding=1,
    ...
    exports.add(
        obj=model.fs.costing.metab.reactor_cost["methane"],
        name="Reactor cost",
        ui_units=model.fs.costing.base_currency / pyunits.m**3,
        display_units="$/m3 of reactor",
        rounding=0,
    ...
    exports.add(
        obj=model.fs.costing.metab.mixer_cost["methane"],
        name="Mixer cost",
        ui_units=model.fs.costing.base_currency / pyunits.kW,
        display_units="$/kW of mixer",
        rounding=0,
    ...
    exports.add(
        obj=model.fs.costing.metab.bead_cost["methane"],
        name="Bead cost",
        ui_units=model.fs.costing.base_currency / pyunits.kg,
        display_units="$/kg",
        rounding=1,
    ...
    exports.add(
        obj=model.fs.costing.metab.bead_replacement_factor["methane"],
        name="Bead replacement factor",
        ui_units=1 / pyunits.year,
        display_units="1/year",
        rounding=2,
    ...
    exports.add(
        obj=model.fs.costing.metab.membrane_sidestream_fraction["methane"],
        name="Membrane side stream",
        ui_units=pyunits.dimensionless,
        display_units="fraction",
        rounding=2,
    ...
    exports.add(
        obj=model.fs.costing.metab.membrane_specific_size["methane"],
        name="Membrane specific size",
        ui_units=pyunits.m**2 / (pyunits.m**3 / pyunits.hr),
        display_units="m2/(m3/h of side stream)",
        rounding=2,
    ...
    exports.add(
        obj=model.fs.costing.metab.membrane_cost["methane"],
        name="Membrane cost",
        ui_units=model.fs.costing.base_currency / pyunits.m**2,
        display_units="$/m2",
        rounding=0,
    ...
    exports.add(
        obj=model.fs.costing.metab.vacuum_cost["methane"],
        name="Vacuum cost",
        ui_units=model.fs.costing.base_currency / (pyunits.kg / pyunits.hr),
    ...
    exports.add(
        ...
        name="Heating cost",
        ui_units=model.fs.costing.base_currency / pyunits.MJ,
        display_units="$/MJ",
        rounding=3,
    ...
    exports.add(
        obj=model.fs.costing.methane_product_cost,
        name="Methane cost",
        ui_units=model.fs.costing.base_currency / pyunits.kg,
        display_units="$/kg",
        rounding=3,
    ...
    exports.add(
        obj=model.fs.product_H2O.properties[0].conc_mass_comp["cod"],
    ...
    exports.add(
        obj=model.fs.product_hydrogen.properties[0].flow_mass_comp["hydrogen"],
    ...
    exports.add(
        obj=model.fs.product_methane.properties[0].flow_mass_comp["methane"],
    ...
    direct_capital_norm = (
        model.fs.metab_hydrogen.costing.direct_capital_cost
        + model.fs.metab_methane.costing.direct_capital_cost
    ...
    removal_cod = (
        1
        - model.fs.product_H2O.properties[0].flow_mass_comp["cod"]
    ...
    hydrogen_production = (
        model.fs.product_hydrogen.properties[0].flow_mass_comp["hydrogen"]
        / model.fs.feed.properties[0].flow_vol
    )
    exports.add(
    ...
    methane_production = (
        model.fs.product_methane.properties[0].flow_mass_comp["methane"]
        / model.fs.feed.properties[0].flow_vol
    )
    exports.add(
    ...
    exports.add(
        obj=model.fs.metab_hydrogen.costing.capital_cost,
    ...
    exports.add(
        obj=model.fs.metab_methane.costing.capital_cost,
    ...
    # Revenue
    total_revenue = -(
        model.fs.costing.aggregate_flow_costs["hydrogen_product"]
        + model.fs.costing.aggregate_flow_costs["methane_product"]
    )
    exports.add(
        obj=total_revenue,
        name="Total",
    ...
    exports.add(
        obj=-model.fs.costing.aggregate_flow_costs["hydrogen_product"],
        name="Hydrogen",
        ui_units=model.fs.costing.base_currency / pyunits.year,
        display_units="$/year",
        rounding=0,
    ...
    exports.add(
        obj=-model.fs.costing.aggregate_flow_costs["methane_product"],
        name="Methane",
        ui_units=model.fs.costing.base_currency / pyunits.year,
        display_units="$/year",
        rounding=0,
