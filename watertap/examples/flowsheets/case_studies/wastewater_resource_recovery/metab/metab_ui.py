...
from watertap.examples.flowsheets.case_studies.wastewater_resource_recovery.metab.metab \
    import (main,
            solve)
...
def export_variables(flowsheet=None, exports=None):
    ...
    # --- Input data ---
    # Feed conditions
    exports.add(obj=fs.feed.flow_vol[0],
    ...
    exports.add(obj=fs.feed.conc_mass_comp[0, "cod"],
    ...
    exports.add(obj=fs.metab_hydrogen.recovery_frac_mass_H2O[0],
                name="Water recovery",
    ...
    exports.add(obj=fs.metab_hydrogen.reaction_conversion[0, "cod_to_hydrogen"],
                name="COD conversion",
                ui_units=pyunits.dimensionless,
                display_units="fraction",  # we should change to %
                rounding=2,
    ...
    exports.add(obj=fs.metab_hydrogen.generation_ratio["cod_to_hydrogen", "hydrogen"],
    ...
    exports.add(obj=fs.metab_methane.recovery_frac_mass_H2O[0],
                name="Water recovery",
                ui_units=pyunits.dimensionless,
                display_units="fraction",  # we should change to %
                rounding=2,
    ...
    exports.add(obj=fs.metab_methane.reaction_conversion[0, "cod_to_methane"],
                name="COD conversion",
                ui_units=pyunits.dimensionless,
                display_units="fraction",  # we should change to %
                rounding=2,
    ...
    exports.add(obj=fs.metab_methane.generation_ratio["cod_to_methane", "methane"],
