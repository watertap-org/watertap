...
def display_costing(m):
    ...
    print(
        "vol R1",
        pyo.value(m.fs.R1.volume[0]),
        pyo.units.get_units(m.fs.R5.volume[0]),
    )
    print(
        "vol R2",
        pyo.value(m.fs.R2.volume[0]),
        pyo.units.get_units(m.fs.R5.volume[0]),
    )
    print(
        "vol R3",
        pyo.value(m.fs.R3.volume[0]),
        pyo.units.get_units(m.fs.R5.volume[0]),
    )
    print(
        "vol R4",
        pyo.value(m.fs.R4.volume[0]),
        pyo.units.get_units(m.fs.R5.volume[0]),
    )
    print(
        "vol R5",
        pyo.value(m.fs.R5.volume[0]),
        pyo.units.get_units(m.fs.R5.volume[0]),
    )
    print(
