...
def main():
    ...
    for key, val in cin_rec.items():
        ...
        file_name = f"recheck_paper_cases_after_erd_fix/{number_of_RO_finite_elements}_nodes_A_5LMHbar_{b_case_lst[0]}_Bmax_{bmax_fn}_{cin}gL_{recovery*100}pct.csv"
