...
def build_prop(m, base="TDS"):
    ...
    if base == "TDS":
        ...
        raise ValueError(
            "Unexpected property base {base} provided to build_prop" "".format(base=base)
        )
...
def get_prop(m, base="TDS"):
    if base == "TDS":
        ...
        raise ValueError("Unexpected property base {base} for get_prop" "".format(base=base))
    return prop
...
def specify_feed(sb, base="TDS"):
    ...
    if base == "TDS":
        ...
        raise ValueError(
            "Unexpected property base {base} provided to specify_feed" "".format(base=base)
        )
