...
def run_analysis(case_num, nx, RO_type):
    ...
    if case_num == 1:
        ...
        output_filename = "output/fs_single_stage/results_%d_%sRO.csv" % (
            case_num,
            desal_kwargs["RO_type"],
        )
        ...
        output_filename = "output/fs_two_stage/results_%d_%sRO_no_sat.csv" % (
            case_num,
            desal_kwargs["RO_type"],
        )
        ...
        output_filename = "output/fs_NF_two_stage/results_%d_%sRO.csv" % (
            case_num,
            desal_kwargs["RO_type"],
        )
        ...
        sweep_params["Lime Dosing"] = LinearSample(
            m.fs.stoich_softening_mixer_unit.lime_stream_state[0].flow_mol, 0.0, 0.128, nx
        )
        ...
        output_filename = "output/fs_softening_two_stage/results_%d_%sRO.csv" % (
            case_num,
            desal_kwargs["RO_type"],
        )
