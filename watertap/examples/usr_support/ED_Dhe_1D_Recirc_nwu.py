...
def main():
    ...
    m.fs.recovery_vol_H2O.fix(0.55)
    condition_base(m)
    ...
    #m.fs.prod.properties[0].conc_mol_phase_comp["Liq", "Na_+"].fix(34.188 * 0.2) #seems to be for initialization
    m.fs.prod.properties[0].conc_mol_phase_comp["Liq", "Na_+"].fix(1.968 * 0.2)
    #m.fs.prod.properties[0].conc_mol_phase_comp["Liq", "Ca_2+"].fix(34.188 * 0.2) #seems to be for initializatin
    m.fs.prod.properties[0].conc_mol_phase_comp["Liq", "Ca_2+"].fix(0.178 * 0.2)
    ...
    #m.fs.prod.properties[0].conc_mol_phase_comp["Liq", "Na_+"].fix(
     #   1.7094 #product Na in mol/s divided by total prod flwo in m3/s
    #)  # Corresponding to C_product = 100 ppb; 
    m.fs.prod.properties[0].conc_mol_phase_comp["Liq", "Na_+"].fix(
        0.8 #product Na in mol/s divided by total prod flwo in m3/s
    )
    #m.fs.prod.properties[0].conc_mol_phase_comp["Liq", "Ca_2+"].fix(
     #   1.7094 
    #)
    m.fs.prod.properties[0].conc_mol_phase_comp["Liq", "Ca_2+"].fix(
        0.8 
...
def condition_base(m):
    ...
    m.fs.EDstack.solute_diffusivity_membrane["cem", "Ca_2+"].fix(3.28e-11)
    m.fs.EDstack.solute_diffusivity_membrane["aem", "Ca_2+"].fix(3.28e-11)
    m.fs.EDstack.solute_diffusivity_membrane["cem", "SO4_2-"].fix(3.28e-11)
    m.fs.EDstack.solute_diffusivity_membrane["aem", "SO4_2-"].fix(3.28e-11)
    m.fs.EDstack.ion_trans_number_membrane["cem", "Na_+"].fix(0.9)
    m.fs.EDstack.ion_trans_number_membrane["aem", "Na_+"].fix(0)
    m.fs.EDstack.ion_trans_number_membrane["cem", "Cl_-"].fix(0)
    m.fs.EDstack.ion_trans_number_membrane["aem", "Cl_-"].fix(0.9)
    m.fs.EDstack.ion_trans_number_membrane["cem", "Ca_2+"].fix(0.1)
    m.fs.EDstack.ion_trans_number_membrane["aem", "Ca_2+"].fix(0)
    m.fs.EDstack.ion_trans_number_membrane["cem", "SO4_2-"].fix(0)
    m.fs.EDstack.ion_trans_number_membrane["aem", "SO4_2-"].fix(0.1)
