...
def build_metab(m):
    ...
    m.fs.metab_effluent.inlet.flow_vol.fix(
        float(get_outlet(df_metab, idx, "VolumetricFlowrate")) * units.m**3 / units.day
    )
...
def get_outlet(df, idx, component):
...
if __name__ == "__main__":
    ...
    output = {
        "METAB effluent": m.fs.metab_effluent.inlet,
        "BSM2 influent": m.fs.metab_effluent.outlet,
    }
