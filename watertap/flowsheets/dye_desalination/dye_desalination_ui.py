...
def export_variables(flowsheet=None, exports=None, build_options=None, **kwargs):
    ...
    exports.add(
        ...
        name="NF water permeability coefficient",
    ...
    exports.add(
        ...
        display_units="fraction",
        rounding=2,
        description="Rejection rate of TDS",
        is_input=False,
        output_category="rHGO Nanofiltration",
        is_output=True,
    )
    ...
    exports.add(
        ...
        display_units="kg/m3",
        rounding=2,
        description="NF retentate concentration of dye",
        is_input=False,
        is_output=True,
        output_category="Outlets",
    )
    exports.add(
        ...
        display_units="kg/m3",
        rounding=2,
        description="NF retentate concentration of TDS",
        is_input=False,
        is_output=True,
        output_category="Outlets",
    )
    ...
    exports.add(
        ...
        display_units="kg/m3",
        rounding=2,
        description="RO permeate concentration of TDS, including residual dye",
        is_input=False,
        is_output=True,
        output_category="Outlets",
    )
    ...
    exports.add(
        ...
        display_units="kg/m3",
        rounding=2,
        description="RO brine concentration of TDS, including residual dye",
        is_input=False,
        is_output=True,
        output_category="Outlets",
    )
