...
def initialize_system(m, solver=None, verbose=True):
    ...
    m.fs.separator_vapor.split_fraction[0, "secondary_steam"].fix(0.3)
    m.fs.separator_vapor.initialize()
    m.fs.separator_vapor.split_fraction[0, "secondary_steam"].unfix()
    ...
    m.fs.SteamEjector.properties_motive_steam[0].flow_mass_phase_comp["Vap", "H2O"].fix()
    ...
    m.fs.condenser.hot_side_inlet.flow_mass_phase_comp[0,"Liq", "H2O"] = m.fs.separator_vapor.secondary_steam.flow_mass_phase_comp[0,"Liq", "H2O"].value
    m.fs.condenser.hot_side_inlet.flow_mass_phase_comp[0,"Vap", "H2O"] = m.fs.separator_vapor.secondary_steam.flow_mass_phase_comp[0,"Vap", "H2O"].value
    m.fs.condenser.hot_side_inlet.temperature[0] = m.fs.separator_vapor.secondary_steam.temperature[0].value
    m.fs.condenser.hot_side_inlet.pressure[0] = m.fs.separator_vapor.secondary_steam.pressure[0].value
...
def optimize_set_up(m):
    ...
    m.fs.SteamEjector.compression_ratio.setlb(1)
