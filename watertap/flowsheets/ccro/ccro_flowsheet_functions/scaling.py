    ...
    if full_scaling:
        ...
        for e in stage.feed_side.eq_friction_factor:
            iscale.constraint_scaling_transform(
                stage.feed_side.eq_friction_factor[e], 1e-2
            )
...
def scale_flushing_system(m=None):
    ...
    overscale_ro(m.fs.RO, m.fs.properties, full_scaling=True)
...
def scale_multiperiod_model(mp):
    ...
    iscale.constraint_scaling_transform(mp.total_permeate_vol_constraint, 1)
