...
def set_operating_conditions(
    m,
    flow_vol=3e-4, # m3/s and 1.8 L/min is 3e-5 m3/s
...
def initialize_mixer(m):
    m.fs.M1.inlet_2_state[0].flow_mass_phase_comp["Liq", "H2O"].set_value(0.000003)
    m.fs.M1.inlet_2_state[0].flow_mass_phase_comp["Liq", "NaCl"].set_value(0.00001)
    m.fs.M1.mixed_state[0].flow_mass_phase_comp["Liq", "H2O"].set_value(0.015)
    m.fs.M1.mixed_state[0].flow_mass_phase_comp["Liq", "NaCl"].set_value(0.001)
