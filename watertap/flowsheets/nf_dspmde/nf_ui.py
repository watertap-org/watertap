...
def export_variables(flowsheet=None, exports=None, build_options=None, **kwargs):
    ...
    exports.add(
        ...
        name="NF product volumetric flow",
        ui_units=pyunits.L / pyunits.hr,
        display_units="L/h",
        rounding=2,
        description="NF product volumetric flow",
        is_input=False,
        input_category="NF design",
        is_output=True,
        output_category="NF design",
    ...
    exports.add(
        ...
        name="NF effective membrane thickness",
        ui_units=pyunits.nm,
        display_units="nm",
        rounding=2,
        description="NF effective membrane thickness",
        is_input=True,
        input_category="NF membrane props.",
        is_output=True,
        output_category="NF membrane props.",
    ...
    exports.add(
        ...
        name="NF membrane charge density",
        ui_units=pyunits.mol / pyunits.m**3,
        display_units="mol/m^3",
        rounding=2,
        description="NF membrane charge density",
        is_input=True,
        input_category="NF membrane props.",
        is_output=True,
        output_category="NF membrane props.",
    ...
    exports.add(
        ...
        name="NF dielectric constant for pore",
        ui_units=pyunits.dimensionless,
        display_units="",
        rounding=2,
        description="NF dielectric pore constant",
        is_input=True,
        input_category="NF membrane props.",
        is_output=True,
        output_category="NF membrane props.",
    ...
    exports.add(
        ...
        name="NF membrane replacment rate",
        ui_units=pyunits.year**-1,
        display_units="fraction/year",
        rounding=3,
        description="NF membrane replacement factor",
        is_input=True,
        input_category="NF CAPEX",
        is_output=True,
        output_category="NF CAPEX",
    ...
    exports.add(
        ...
        rounding=2,
        description="Plant utilization factor",
        is_input=True,
        input_category="NF OPEX",
        is_output=True,
        output_category="NF OPEX",
    ...
    exports.add(
        ...
        rounding=4,
        description="Annual maintenance-labor-chemical factor",
        is_input=True,
        input_category="NF OPEX",
        is_output=True,
        output_category="NF OPEX",
    ...
    exports.add(
        ...
        display_units="mg/L",
        rounding=2,
        description="Product hardness as CaCO3",
        is_input=True,
        input_category="System constraints",
        is_output=False,
        output_category="System constraints",
    ...
    exports.add(
        ...
        name="Product volumetric flow",
        ui_units=pyunits.L / pyunits.hr,
        display_units="L/h",
        rounding=2,
        description="Product liquid volumetric flow",
        is_input=False,
        input_category="System streams",
        is_output=True,
        output_category="System streams",
    ...
    exports.add(
        ...
        name="Disposal volumetric flow",
        ui_units=pyunits.L / pyunits.hr,
        display_units="L/h",
        rounding=2,
        description="Disposal volumetric flow",
        is_input=False,
        input_category="System streams",
        is_output=True,
        output_category="System streams",
