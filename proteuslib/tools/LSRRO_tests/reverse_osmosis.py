...
from pyomo.environ import Var, Constraint, Param, Expression, SolverFactory, \
    TerminationCondition, Suffix, NonNegativeReals, units as pyunits, Reference, Block
    ...
    **Valid values:** {
    ...
    def build(self):
        ...
        def eq_connect_mass_transfer(b, t, j):
            ...
            # return b.properties_permeate[t].flow_mass_comp[j] == b.mass_transfer_comp[t, j]
