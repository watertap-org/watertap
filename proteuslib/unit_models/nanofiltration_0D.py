    ...
    **Valid values:** {
    ...
    def build(self):
        ...
        if len(self.solvent_list) > 1:
            ConfigurationError("NF model only supports one solvent component,"
                               "the provided property package has specified {} solvent components"
                               .format(len(self.solvent_list)))

        if len(self.solute_list) > 1:
            ConfigurationError("NF model only supports one solute component,"
                               "the provided property package has specified {} solute components"
                               .format(len(self.solute_list)))
