...
def build_prop_TDS(m):
    """
    Build seawater property package based on TDS. Includes default scaling.
    """
...
def build_prop_salt(m):
    """
    Build seawater property package based on salt. Includes default scaling.
    """
...
def specify_feed_salt(sb):
    """
    Fixes the state variables on the stateblock to the base seawater composition for
    seawater package based on salts.
    """
    # specify
    feed_flow_mass = 1
...
def specify_feed_ion(sb):
    """
    Fixes the state variables on the stateblock to the base seawater composition for
    seawater package based on ions.
    """
    # specify
    feed_flow_mass = 1
...
if __name__ == "__main__":
    ...
    run_specify_seawater('salt')
    run_specify_seawater('ion')
